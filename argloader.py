...
def get_args():
    ...
    parser.add_argument("-N", type=int, default=10, help="number of steps from pdata to pprior i.e. length of bridges")
    parser.add_argument("--gamma0", type=float, default=1e-5, help="step size used for sampling, such that T=gamma*N")
    parser.add_argument("--gamma_bar", type=float, default=1e-1, help="step size used for sampling, such that T=gamma*N")
    parser.add_argument("--n_epoch", type=int, default=5_000, help="number of epochs for each IPF iteration")
    parser.add_argument("--cache_size", type=int, default=50_000, help="size of the cache used during training")
    parser.add_argument("--cache_period", type=int, default=1_000, help="number of epochs between each cache renewal")
    parser.add_argument("--batch_size", type=int, default=128, help="batch size for training")
    parser.add_argument("--lr", type=float, default=1e-4, help="learning rate used for training")
